...
<div itemscope itemtype="http://schema.org/Product">
	<div class="primary_block row">
		...
		{/if}
		<!-- left infos-->  
		<div class="pb-left-column col-xs-12 {if $columns == 2} col-sm-12 col-md-6 two-columns{elseif $columns == 3} col-md-12 three-columns{else} col-sm-4 col-md-5{/if}">
			<!-- product img-->        
        ...
        <!-- center infos -->
		<div class="pb-center-column col-xs-12 {if $columns == 2} col-sm-12 col-md-6{elseif $columns == 3} col-sm-12{else} col-sm-4{/if}">
        ...
        <!-- pb-right-column-->
		<div class="pb-right-column col-xs-12 {if $columns == 2} col-sm-12 col-md-12 two-colums{elseif $columns == 3} col-md-12 three-colums{else} col-sm-4 col-md-3{/if}">
			...
			<section class="page-product-box">
				...
				<form method="post" action="{$customizationFormTarget}" enctype="multipart/form-data" id="customizationForm" class="clearfix">
					...
					<p id="customizedDatas">
						...
						<button class="button btn btn-default btn-sm" name="saveCustomization">
							<span>{l s='Save'}</span>
						</button>
