...
$(document).ready(function(){
	...
	$("#htmlcontent_home").appendTo("#top_column");
	$('#categories_block_left .block_content > ul').find('>li:odd').addClass('odd');
	$('#categories_block_left .block_content > ul').find('>li:even').addClass('even');
	highdpiInit();
	responsiveResize();
